// See https://vulkan-tutorial.com/en/Depth_buffering#page_Framebuffer
...
private:
    ...
    VkImageView createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags)
    {
        ...
        auto result = vkCreateImageView(m_logicalDevice, &viewInfo, nullptr, &imageView);
        if (result != VK_SUCCESS)
        {
    ...
    void createTextureSampler()
    {
        ...
        auto result = vkCreateSampler(m_logicalDevice, &samplerInfo, nullptr, &m_textureSampler);
        if (result != VK_SUCCESS)
        {
